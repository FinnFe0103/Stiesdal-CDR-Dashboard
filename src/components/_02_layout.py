...
from . import _03_date_select, _03_method_dropdown, _05_purchaser_chart, _05_supplier_chart, _05_KPIs, _06_price_chart, _07_pie_chart
...
def create_layout(app: Dash, data: pd.DataFrame) -> html.Div:
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                children=[_07_pie_chart.render(app, data)],
                style={"width": "45%", "display": "inline-block", "margin-left": "60px"}
            ),
        ]
    )
