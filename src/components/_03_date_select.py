...
def render(app: Dash, data: pd.DataFrame) -> html.Div:
    ...
    @app.callback(
        ...
        [Output(_00_own_ids.DATE_RANGE, "start_date"),
         Output(_00_own_ids.DATE_RANGE, "end_date")],
        # input: # of clicks for the WHOLE_RANGE button
        [Input(_00_own_ids.SELECT_WHOLE_RANGE_BUTTON, "n_clicks"),
         Input(_00_own_ids.SELECT_LAST_MONTH_BUTTON, "n_clicks"),
         Input(_00_own_ids.SELECT_LAST_YEAR_BUTTON, "n_clicks")],
    )
    ...
    def update_range(btn1, btn2, btn3):
        ...
        if _00_own_ids.SELECT_LAST_MONTH_BUTTON == ctx.triggered_id:
            min_date = max_date - dt.timedelta(30)
        # Select last year button
        elif _00_own_ids.SELECT_LAST_YEAR_BUTTON == ctx.triggered_id:
            ...
            html.Div(
                ...
                children=[
                    html.Button(
                        ...
                        id=_00_own_ids.SELECT_WHOLE_RANGE_BUTTON,
                    ...
                    html.Button(
                        ...
                        children=["Last year"],
                        # need id that lets us refer to the button
                        id=_00_own_ids.SELECT_LAST_YEAR_BUTTON,
                        # # clicks is the parameter that the callback function listens to
                        n_clicks=0,
                    ...
                    html.Button(
                        ...
                        # need id that lets us refer to the button
                        id=_00_own_ids.SELECT_LAST_MONTH_BUTTON,
                        # # clicks is the parameter that the callback function listens to
                        n_clicks=0,
                        style={"margin-left": "5px"}
                    )
